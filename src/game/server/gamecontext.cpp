...
void CGameContext::CreateExplosion(vec2 Pos, int Owner, int Weapon, bool NoDamage, int64_t Mask, int DamageMode)
{
	// create the event
...
{
	if(!(Server()->IsSixup(TargetID)) || !m_apPlayers[ClientID])
	  	return;
...
void CGameContext::OnClientEnter(int ClientID)
{
	...
	SendChatTarget(ClientID, "Link: https://crowdin.com/project/teeworlds-classpvp");
