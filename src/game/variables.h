...
MACRO_CONFIG_INT(SvScorelimit, sv_scorelimit, 20, 0, 10000, CFGFLAG_SERVER, "Score limit")
MACRO_CONFIG_INT(SvTimelimit, sv_timelimit, 0, 0, 1000, CFGFLAG_SERVER, "Time limit in minutes")
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "dm", CFGFLAG_SERVER, "Game type (Change it wiil no happend)")
