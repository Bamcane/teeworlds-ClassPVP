...
int CMapConverter::ConvertMapTo7(const char* pFilename)
{
    ...
    str_format(pSourceFileName, sizeof(pSourceFileName), "maps/%s.map", pFilename);
    str_format(aDestFileName, sizeof(aDestFileName), "clientmaps/classpvp/%s7.map", pFilename);
